...
public class eje5 {
    public static int funcion (int linea, int columnas, int contador){
        if ((columnas==1)) {
            ...
            int resultado = (funcion((linea-1), columnas, contador) + funcion(linea-1, columnas-1, contador));
            return resultado;
        }else{
            int resultado = (funcion((linea - 1), (columnas), contador) + funcion((linea - 1), (columnas-1), contador) + funcion((linea - 1), (columnas-2), contador));
            return resultado;
        }
